...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[500vh] md:min-h-[400vh] py-20 md:py-40 pb-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
