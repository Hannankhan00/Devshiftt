...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[400vh] md:min-h-[300vh] py-20 md:py-40 pb-32 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
